...
// Source: internal/modules/cliente/usecases/update/interfaces.go
//
...
func (m *MockIUsecase) Execute(id string, p *dto.Request) (*dto.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", id, p)
...
func (mr *MockIUsecaseMockRecorder) Execute(id, p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Execute", reflect.TypeOf((*MockIUsecase)(nil).Execute), id, p)
}
